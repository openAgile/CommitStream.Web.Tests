...
module.exports = class BaseAPI {
    constructor() {
        ...
        this.bitBucketPullRequestData = {
          ...
          "pullrequest": {
            "type": "pullrequest",
            "comment_count": 0,
            "description": "It's a pull request!",
            "links": {
              "html": {
    ...
    pushBitbucketPullRequest({instanceId, apiKey, inboxId}) {
        let pullRequestData = this.bitBucketPullRequestData;
        let commitUrl = this.rootUrl + instanceId + '/inboxes/' + inboxId + '/commits?apiKey=' + apiKey;
        return axios.post(commitUrl,
            pullRequestData,
            {
